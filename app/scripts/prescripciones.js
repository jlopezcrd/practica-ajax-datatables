...
function cargarDatos() {
    $('#prescripciones').dataTable( {
        ...
        "ajax": "http://localhost:8888/practica-ajax-datatables/app/getPrescripciones.php",
        "columns": [
        { "data": "id_prescripciones",
...
function actualizarTablaDatos() {
    $('#prescripciones').dataTable()._fnAjaxUpdate();
